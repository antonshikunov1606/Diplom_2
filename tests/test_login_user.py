...
class TestLoginUser:
    ...
    def test_successful_login_courier(self, registration_user, delete_user):
        payload = credentials
    ...
    def test_login_with_incorrect_data_not_allowed(self, incorrect_data, registration_user, delete_user):
        payload = credentials
